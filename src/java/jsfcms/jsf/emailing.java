...
public  class emailing extends Thread {
        ...
        try {
            ...
            props.put("mail.smtp.starttls.enable", "true");//makhsuse gmail
            props.put("mail.smtp.host", smtpServer);
            props.put("mail.smtp.port", "587");
            props.put("mail.smtp.auth", "true");
            props.put("mail.smtp.ssl.trust", "smtp.gmail.com");//khodam addesh kardam
    ...
    private class SMTPAuthenticator extends javax.mail.Authenticator {
        ...
        public PasswordAuthentication getPasswordAuthentication() {
            String username = "jsfcms@gmail.com";//"no-reply@khazeshgar.com";           // specify your email id here (sender's email id)
            String password = "behopebehope";//"";                                      // specify your password here
            return new PasswordAuthentication(username, password);
        }
    }
    public static void main(String ap[]){
        
            emailing mnm = new emailing("message", "subject", "text/html", "mohammad.ghasemy@gmail.com");
